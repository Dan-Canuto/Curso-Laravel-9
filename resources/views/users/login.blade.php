...
@section('content')
<center>
    <h1 class="text-2x1 font-semibold leading-tigh py-2">Login</h1>
...
<form class="border-2 border-black bg-blue-200 rounded p-5 w-1/5" action="{{route('users.valida')}}" method="POST">
    @csrf
